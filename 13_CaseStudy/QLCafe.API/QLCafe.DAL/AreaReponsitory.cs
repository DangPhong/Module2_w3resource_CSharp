...
{
    class AreaReponsitory : BaseReponsitory, IAreaResponsitory
    {
        ...
        {
            IList<Area> areaList = SqlMapper.Query<Area>(con, "Areas_Add", commandType: CommandType.StoredProcedure).ToList();
            return areaList;
        }
